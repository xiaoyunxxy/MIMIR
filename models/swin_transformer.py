...
def swin_tiny(**kwargs):
    model = SwinTransformer(
        patch_size=model_args_tiny['patch_size'],
        embed_dim=model_args_tiny['embed_dim'],
        depths=model_args_tiny['depths'],
        num_heads=model_args_tiny['num_heads'],
        window_size=model_args_tiny['window_size'], **kwargs)
    return model

def swin_small(**kwargs):
    model = SwinTransformer(
        patch_size=model_args_small['patch_size'],
        embed_dim=model_args_small['embed_dim'],
        depths=model_args_small['depths'],
        num_heads=model_args_small['num_heads'],
        window_size=model_args_small['window_size'], **kwargs)
    return model

def swin_base(**kwargs):
    model = SwinTransformer(
        patch_size=model_args_base['patch_size'],
        embed_dim=model_args_base['embed_dim'],
        depths=model_args_base['depths'],
        num_heads=model_args_base['num_heads'],
        window_size=model_args_base['window_size'], **kwargs)
    return model
