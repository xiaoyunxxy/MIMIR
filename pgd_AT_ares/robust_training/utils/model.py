...
from .convnext_official import convnext_base, convnext_large
...
def mimir_model(args):
    if args.model.startswith('swin_base'):
        ...
        print('Loading MIMIR convnext_base pretrain weights...')
        ...
        print('Loading MIMIR convnext_large pretrain weights...')
